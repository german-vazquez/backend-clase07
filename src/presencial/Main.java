...
public class Main {
    public static void main(String[] args) {
        ...
        Computadora compu2=computadoraFactory.getComputadora(16,500);
        Computadora compu3=computadoraFactory.getComputadora(8,500);
        Computadora compu4=computadoraFactory.getComputadora(16,500);
